...
class ExampleSim(mosaik_api.Simulator):
    def __init__(self):
        ...
        self.time = 0 #Mosaik 3.0: novo atributo 'self.time = 0' no método __init__()
    ...
    def step(self, time, inputs, max_advance):
        self.time = time  # Mosaik 3.0: Adicionado atributo self.time
